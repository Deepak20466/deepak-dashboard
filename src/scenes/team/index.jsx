...
const Team = () => {
  ...
  // 1. Create a state variable for our rows
  ...
  useEffect(() => {
    ...
    if (savedData) {
      ...
      // Combine mock data with our newly created users
      setTeamData([...mockDataTeam, ...parsedData]);
    }
  }, []);
  ...
  return (
    <Box m="20px">
      ...
      >
        {/* 3. Use the state variable teamData instead of mockDataTeam */}
